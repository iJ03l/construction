          ...
          <div className="grid grid-cols-12 font-monserrat  w-full">
            ...
            <div className="md:col-span-6 bg-gray-800 col-span-12 md:p-20 p-6 items-start">
              <h1 className="text-6xl py-5 font-bold uppercase text-green-600">
                <span className="font-light text-orange-500">what we</span>{" "}
                offer
              </h1>
            ...
            <div className="col-span-12 mb-10">
              <div className="flex md:w-[50%] mx-auto flex-col items-start justify-center -mt-20 md:-mt-20 bg-gray-200 text-xl p-6 md:p-20 mb-10 shadow-xl">
                <div className="collapse">
                  ...
                  <div className="collapse-content">
                    <p className="font-light text-sm">
                      ...
                      and infrastructure development. We provide turnkey
                      solutions for all phases of construction, from planning
                      and design to project management and execution. Our team
                      of experts work closely with clients to ensure that their
                      vision is realized, while also taking into account
                      budgetary constraints and timelines. We use the latest
                      technology and equipment to ensure that our projects are
                      completed to the highest quality standards, with a focus
                ...
                <div className="collapse">
                  ...
                  <div className="collapse-content">
                    <p className="font-light text-sm">
                      ...
                      industrial sites. These services include the design and
                      installation of electrical wiring, lighting systems, power
                      distribution systems, and electrical control systems.
                      Electrical contractors also provide troubleshooting and
                      repair services to address electrical problems such as
                      power outages, circuit overloads, and electrical equipment
                      malfunctions. Additionally, electrical contractors offer
                      maintenance services to ensure that electrical systems
                      continue to function optimally and efficiently. Overall,
                      electrical services are essential for ensuring the safe
                      and efficient operation of electrical systems in
                ...
                <div className="collapse">
                  ...
                  <div className="collapse-content">
                    <p className="font-light text-sm">
                      ...
                      Our team of experts works closely with clients to design
                      and implement solar solutions that maximize energy
                      production, reduce costs, and minimize environmental
                      impact. From residential rooftops to large-scale
                      commercial installations, we have the experience and
                      expertise to deliver high-quality, customized solar power
                      solutions.
                    </p>
                  </div>
                </div>
                <div className="collapse">
                  ...
                  <div className="collapse-content">
                    <p className="font-light text-sm">
                      ...
                      needs of our clients. We have established relationships
                      with top manufacturers and suppliers in the industry,
                      allowing us to source solar equipment at competitive
                      prices. Whether it's for a small residential project or a
                      large commercial installation, we are committed to
                      providing our clients with the best solar equipment
                ...
                <div className="collapse">
                  ...
                  <div className="collapse-content">
                    <p className="font-light text-sm">
                      Solar Powered Boreholes are water systems that utilize
                      solar energy to pump water from underground sources to the
                      surface. These systems are a reliable and sustainable
                      source of water for communities, farms, and rural areas
                      where access to water is limited or nonexistent. The solar
                      panels used to power the boreholes are designed to convert
                      sunlight into electricity, which is stored in batteries
                      for use when the sun is not shining. This method of
                      pumping water is cost-effective, environmentally friendly,
                      and provides a long-term solution to water scarcity. The
                      installation of solar-powered boreholes has proven to be a
                      game-changer in many areas around the world, providing
                      clean and safe water to communities and reducing their
